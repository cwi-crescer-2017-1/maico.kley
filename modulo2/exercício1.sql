...
create table produto(
	...
	constraint pk_produto primary key (cod_id)
)

insert into produto(nomecurto, nomedescritivo, datainscricao, localestoque, quantidade, preco)
values ('teste', 'testando se funciona com bastantes letras', '28/04/2017', 'aquela rua la perto da loja', 4, 1.99)

select * from produto;

insert into produto(nomecurto, nomedescritivo, datainscricao, localestoque, quantidade, preco)
values ('teste2', 'testando se funciona com bastantes letras2', '28/04/2017 05:30:40', 'aquela rua la perto da loja2', 4, 1.99)